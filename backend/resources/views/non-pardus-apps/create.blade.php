<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 bg-white mt-8 shadow-xl rounded-lg ">
        ...
        <form class="w-full space-y-8" action="{{ route('non-pardus-apps.store') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center ">
                ...
                <x-jet-input class="w-full" name="image_url" type="text" value="{{ old('image_url') }}"></x-jet-input>
            </div>
